...
namespace War3Net.Build.Script
{
    internal sealed class CSharpScriptCompiler : ScriptCompiler
    {
        ...
        {
            var functionBuilderData = new FunctionBuilderData(Options.MapInfo, Options.MapDoodads, Options.MapUnits, Options.MapRegions, Options.MapSounds, Options.LobbyMusic, Options.SourceDirectory != null);
