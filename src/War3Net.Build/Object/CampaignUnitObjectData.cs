...
namespace War3Net.Build.Object
{
    public sealed class CampaignUnitObjectData
    {
        ...
        public CampaignUnitObjectData(params ObjectModification[] modifications)
            : this()
        {
        ...
        public static CampaignUnitObjectData Default => new CampaignUnitObjectData() { _fileFormatVersion = ObjectDataFormatVersion.Normal, };
        ...
        public static CampaignUnitObjectData Parse(Stream stream, bool leaveOpen = false)
        {
            try
            {
                var data = new CampaignUnitObjectData();
        ...
        public static void Serialize(CampaignUnitObjectData objectData, Stream stream, bool leaveOpen = false)
        {
