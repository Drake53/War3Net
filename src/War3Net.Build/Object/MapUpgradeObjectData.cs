...
{
    public sealed class MapUpgradeObjectData
    {
        ...
        public MapUpgradeObjectData(params ObjectModification[] modifications)
            : this()
        {
            SetData(modifications);
        }

        internal MapUpgradeObjectData()
        {
            _baseModifications = new Dictionary<int, ObjectModification>();
            _newModifications = new Dictionary<int, ObjectModification>();
        }

        public static MapUpgradeObjectData Default => new MapUpgradeObjectData() { _fileFormatVersion = ObjectDataFormatVersion.Normal, };
        ...
        public static MapUpgradeObjectData Parse(Stream stream, bool leaveOpen = false)
        {
            try
            {
                var data = new MapUpgradeObjectData();
        ...
        public static void Serialize(MapUpgradeObjectData objectData, Stream stream, bool leaveOpen = false)
        {
