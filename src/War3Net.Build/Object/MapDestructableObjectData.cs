...
{
    public sealed class MapDestructableObjectData
    {
        ...
        public static MapDestructableObjectData Default => new MapDestructableObjectData() { _fileFormatVersion = ObjectDataFormatVersion.Normal, };
        ...
        public static MapDestructableObjectData Parse(Stream stream, bool leaveOpen = false)
        {
            try
            {
                var data = new MapDestructableObjectData();
        ...
        public static void Serialize(MapDestructableObjectData objectData, Stream stream, bool leaveOpen = false)
        {
