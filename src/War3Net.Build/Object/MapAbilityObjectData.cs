...
{
    public sealed class MapAbilityObjectData
    {
        ...
        public MapAbilityObjectData(params ObjectModification[] modifications)
            : this()
        {
            SetData(modifications);
        }

        internal MapAbilityObjectData()
        {
            _baseModifications = new Dictionary<int, ObjectModification>();
            _newModifications = new Dictionary<int, ObjectModification>();
        }

        public static MapAbilityObjectData Default => new MapAbilityObjectData() { _fileFormatVersion = ObjectDataFormatVersion.Normal, };
        ...
        public static MapAbilityObjectData Parse(Stream stream, bool leaveOpen = false)
        {
            try
            {
                var data = new MapAbilityObjectData();
        ...
        public static void Serialize(MapAbilityObjectData objectData, Stream stream, bool leaveOpen = false)
        {
