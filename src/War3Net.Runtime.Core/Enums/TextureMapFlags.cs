...
{
    public sealed class TextureMapFlags : Handle
    {
        ...
        public static implicit operator Type(TextureMapFlags textureMapFlags) => textureMapFlags._type;

        public static explicit operator int(TextureMapFlags textureMapFlags) => (int)textureMapFlags._type;
