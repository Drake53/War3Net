...
{
    public sealed class TargetFlag : Handle
    {
        ...
        public static implicit operator Type(TargetFlag targetFlag) => targetFlag._type;

        public static explicit operator int(TargetFlag targetFlag) => (int)targetFlag._type;
