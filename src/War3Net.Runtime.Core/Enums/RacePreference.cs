...
{
    public sealed class RacePreference : Handle
    {
        ...
        public static implicit operator Type(RacePreference racePreference) => racePreference._type;

        public static explicit operator int(RacePreference racePreference) => (int)racePreference._type;
