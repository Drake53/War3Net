...
{
    public sealed class UnitIntegerField : Handle
    {
        ...
        public static implicit operator Type(UnitIntegerField unitIntegerField) => unitIntegerField._type;

        public static explicit operator int(UnitIntegerField unitIntegerField) => (int)unitIntegerField._type;
