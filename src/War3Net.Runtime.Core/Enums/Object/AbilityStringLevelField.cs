...
{
    public sealed class AbilityStringLevelField : Handle
    {
        ...
        public static implicit operator Type(AbilityStringLevelField abilityStringLevelField) => abilityStringLevelField._type;

        public static explicit operator int(AbilityStringLevelField abilityStringLevelField) => (int)abilityStringLevelField._type;
