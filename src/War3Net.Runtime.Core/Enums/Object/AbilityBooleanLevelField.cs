...
{
    public sealed class AbilityBooleanLevelField : Handle
    {
        ...
        public static implicit operator Type(AbilityBooleanLevelField abilityBooleanLevelField) => abilityBooleanLevelField._type;

        public static explicit operator int(AbilityBooleanLevelField abilityBooleanLevelField) => (int)abilityBooleanLevelField._type;
