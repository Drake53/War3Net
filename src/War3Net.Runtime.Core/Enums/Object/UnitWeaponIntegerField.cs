...
{
    public sealed class UnitWeaponIntegerField : Handle
    {
        ...
        public static implicit operator Type(UnitWeaponIntegerField unitWeaponIntegerField) => unitWeaponIntegerField._type;

        public static explicit operator int(UnitWeaponIntegerField unitWeaponIntegerField) => (int)unitWeaponIntegerField._type;
