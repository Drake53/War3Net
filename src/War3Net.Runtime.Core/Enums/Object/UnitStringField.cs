...
{
    public sealed class UnitStringField : Handle
    {
        ...
        public static implicit operator Type(UnitStringField unitStringField) => unitStringField._type;

        public static explicit operator int(UnitStringField unitStringField) => (int)unitStringField._type;
