...
namespace War3Net.Runtime.Enums.Object
{
    public sealed class UnitRealField : Handle
    {
        ...
        public static implicit operator Type(UnitRealField unitRealField) => unitRealField._type;

        public static explicit operator int(UnitRealField unitRealField) => (int)unitRealField._type;
