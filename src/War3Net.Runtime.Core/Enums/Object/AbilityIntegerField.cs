...
{
    public sealed class AbilityIntegerField : Handle
    {
        ...
        public static implicit operator Type(AbilityIntegerField abilityIntegerField) => abilityIntegerField._type;

        public static explicit operator int(AbilityIntegerField abilityIntegerField) => (int)abilityIntegerField._type;
