...
{
    public sealed class ItemBooleanField : Handle
    {
        ...
        public static implicit operator Type(ItemBooleanField itemBooleanField) => itemBooleanField._type;

        public static explicit operator int(ItemBooleanField itemBooleanField) => (int)itemBooleanField._type;
