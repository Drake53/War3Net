...
{
    public sealed class FrameEventType : Handle
    {
        ...
        public static implicit operator Type(FrameEventType frameEventType) => frameEventType._type;

        public static explicit operator int(FrameEventType frameEventType) => (int)frameEventType._type;
