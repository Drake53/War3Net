...
{
    public sealed class PlayerState : Handle
    {
        ...
        public static implicit operator Type(PlayerState playerState) => playerState._type;

        public static explicit operator int(PlayerState playerState) => (int)playerState._type;
