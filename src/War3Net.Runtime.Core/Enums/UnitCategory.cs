...
{
    public sealed class UnitCategory : Handle
    {
        ...
        public static implicit operator Type(UnitCategory unitCategory) => unitCategory._type;

        public static explicit operator int(UnitCategory unitCategory) => (int)unitCategory._type;
