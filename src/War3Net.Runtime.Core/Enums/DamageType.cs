...
{
    public sealed class DamageType : Handle
    {
        ...
        public static implicit operator Type(DamageType damageType) => damageType._type;

        public static explicit operator int(DamageType damageType) => (int)damageType._type;
