...
{
    public sealed class AnimationType : Handle
    {
        ...
        public static implicit operator Type(AnimationType animationType) => animationType._type;

        public static explicit operator int(AnimationType animationType) => (int)animationType._type;
