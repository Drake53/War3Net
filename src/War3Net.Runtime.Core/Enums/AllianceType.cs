...
{
    public sealed class AllianceType : Handle
    {
        ...
        public static implicit operator Type(AllianceType allianceType) => allianceType._type;

        public static explicit operator int(AllianceType allianceType) => (int)allianceType._type;
