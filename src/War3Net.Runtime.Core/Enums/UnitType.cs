...
{
    public sealed class UnitType : Handle
    {
        ...
        public static implicit operator Type(UnitType unitType) => unitType._type;

        public static explicit operator int(UnitType unitType) => (int)unitType._type;
