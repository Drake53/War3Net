...
namespace War3Net.Runtime.Enums.Event
{
    public sealed class PlayerUnitEvent : EventId
    {
        ...
        public static implicit operator Type(PlayerUnitEvent playerUnitEvent) => playerUnitEvent._type;

        public static explicit operator int(PlayerUnitEvent playerUnitEvent) => (int)playerUnitEvent._type;
