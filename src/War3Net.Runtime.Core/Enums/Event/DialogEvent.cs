...
namespace War3Net.Runtime.Enums.Event
{
    public sealed class DialogEvent : EventId
    {
        ...
        public static implicit operator Type(DialogEvent dialogEvent) => dialogEvent._type;

        public static explicit operator int(DialogEvent dialogEvent) => (int)dialogEvent._type;
