...
namespace War3Net.Runtime.Enums.Event
{
    public sealed class PlayerEvent : EventId
    {
        ...
        public static implicit operator Type(PlayerEvent playerEvent) => playerEvent._type;

        public static explicit operator int(PlayerEvent playerEvent) => (int)playerEvent._type;
