...
{
    public sealed class PlayerScore : Handle
    {
        ...
        public static implicit operator Type(PlayerScore playerScore) => playerScore._type;

        public static explicit operator int(PlayerScore playerScore) => (int)playerScore._type;
