...
{
    public sealed class PathingFlag : Handle
    {
        ...
        public static implicit operator Type(PathingFlag pathingFlag) => pathingFlag._type;

        public static explicit operator int(PathingFlag pathingFlag) => (int)pathingFlag._type;
