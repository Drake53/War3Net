    ...
    public partial class JassToCSharpTranspiler
    {
        public MemberDeclarationSyntax Transpile(JassNativeFunctionDeclarationSyntax nativeFunctionDeclaration)
        {
            return SyntaxFactory.MethodDeclaration(
                ...
                Transpile(nativeFunctionDeclaration.ReturnClause.ReturnType),
                null,
                Transpile(nativeFunctionDeclaration.IdentifierName.Token),
                null,
                SyntaxFactory.ParameterList(Transpile(nativeFunctionDeclaration.ParameterList)),
                default,
                null,
                null,
