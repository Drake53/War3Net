...
namespace War3Net.CodeAnalysis.Transpilers
{
    ...
    {
        public static ExpressionSyntax Transpile(this Jass.Syntax.ExpressionSyntax expressionNode)
        {
        ...
        public static ExpressionSyntax Transpile(this Jass.Syntax.ExpressionSyntax expressionNode, out bool @const)
        {
            _ = expressionNode ?? throw new ArgumentNullException(nameof(expressionNode));
