...
namespace War3Net.CodeAnalysis.Jass.Syntax
{
    public class JassReturnClauseSyntax : JassSyntaxNode
    {
        ...
        public override JassSyntaxKind SyntaxKind => JassSyntaxKind.ReturnClause;
        ...
        public override void Accept(IJassSyntaxVisitor visitor) => visitor.VisitReturnClause(this);
