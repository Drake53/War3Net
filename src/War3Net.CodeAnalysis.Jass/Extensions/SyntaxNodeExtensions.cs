...
namespace War3Net.CodeAnalysis.Jass.Extensions
{
    ...
    {
        public static TSyntaxNode WithLeadingTrivia<TSyntaxNode>(this TSyntaxNode syntaxNode, JassSyntaxTriviaList trivia)
        ...
        public static TSyntaxNode WithTrailingTrivia<TSyntaxNode>(this TSyntaxNode syntaxNode, JassSyntaxTriviaList trivia)
            where TSyntaxNode : JassSyntaxNode
        {
        ...
        public static TSyntaxNode PrependTrivia<TSyntaxNode>(this TSyntaxNode syntaxNode, JassSyntaxTriviaList trivia)
            where TSyntaxNode : JassSyntaxNode
        {
            var oldToken = syntaxNode.GetFirstToken();
        ...
        public static TSyntaxNode AppendTrivia<TSyntaxNode>(this TSyntaxNode syntaxNode, JassSyntaxTriviaList trivia)
            where TSyntaxNode : JassSyntaxNode
        {
            var oldToken = syntaxNode.GetLastToken();
