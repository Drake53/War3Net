...
namespace War3Net.CodeAnalysis.Jass
{
    ...
    {
        private bool TryRenameFunctionDeclaration(JassFunctionDeclarationSyntax functionDeclaration, [NotNullWhen(true)] out IDeclarationSyntax? renamedFunctionDeclaration)
        {
