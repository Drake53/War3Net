...
namespace War3Net.Build.Object
{
    ...
    {
        internal VariationObjectModification(JsonElement jsonElement, ObjectDataFormatVersion formatVersion)
        {
            GetFrom(jsonElement, formatVersion);
        }

        internal VariationObjectModification(ref Utf8JsonReader reader, ObjectDataFormatVersion formatVersion)
        {
        ...
        internal void GetFrom(JsonElement jsonElement, ObjectDataFormatVersion formatVersion)
        {
            ...
            {
                Modifications.Add(element.GetVariationObjectDataModification(formatVersion));
            }
        }
