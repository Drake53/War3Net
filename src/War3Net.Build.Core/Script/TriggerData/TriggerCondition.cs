...
namespace War3Net.Build.Script
{
    public sealed partial class TriggerData
    {
        ...
        {
            public TriggerCondition(string key, params string[] values)
            {
                ConditionFunctionName = key;
            ...
            public string ConditionFunctionName { get; }

            public int GameVersion { get; }

            public ImmutableArray<string> ArgumentTypes { get; }

            public override string ToString() => ConditionFunctionName;
        }
    }
}