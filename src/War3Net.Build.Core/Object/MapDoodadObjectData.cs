...
namespace War3Net.Build.Object
{
    public sealed class MapDoodadObjectData
    {
        ...
        public MapDoodadObjectData(params ObjectModification[] modifications)
            : this()
        {
        ...
        public static MapDoodadObjectData Default => new MapDoodadObjectData() { _fileFormatVersion = ObjectDataFormatVersion.Normal, };
        ...
        public static MapDoodadObjectData Parse(Stream stream, bool leaveOpen = false)
        {
            try
            {
                var data = new MapDoodadObjectData();
        ...
        public static void Serialize(MapDoodadObjectData objectData, Stream stream, bool leaveOpen = false)
        {
