...
{
    public sealed class CampaignItemObjectData
    {
        ...
        public CampaignItemObjectData(params ObjectModification[] modifications)
            : this()
        {
        ...
        internal CampaignItemObjectData()
        {
            _baseModifications = new Dictionary<int, ObjectModification>();
            _newModifications = new Dictionary<int, ObjectModification>();
        }

        public static CampaignItemObjectData Default => new CampaignItemObjectData() { _fileFormatVersion = ObjectDataFormatVersion.Normal, };
        ...
        public static CampaignItemObjectData Parse(Stream stream, bool leaveOpen = false)
        {
            try
            {
                var data = new CampaignItemObjectData();
        ...
        public static void Serialize(CampaignItemObjectData objectData, Stream stream, bool leaveOpen = false)
        {
