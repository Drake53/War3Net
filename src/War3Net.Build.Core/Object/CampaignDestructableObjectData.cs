...
{
    public sealed class CampaignDestructableObjectData
    {
        ...
        public CampaignDestructableObjectData(params ObjectModification[] modifications)
            : this()
        {
        ...
        internal CampaignDestructableObjectData()
        {
            _baseModifications = new Dictionary<int, ObjectModification>();
            _newModifications = new Dictionary<int, ObjectModification>();
        }

        public static CampaignDestructableObjectData Default => new CampaignDestructableObjectData() { _fileFormatVersion = ObjectDataFormatVersion.Normal, };
        ...
        public static CampaignDestructableObjectData Parse(Stream stream, bool leaveOpen = false)
        {
            try
            {
                var data = new CampaignDestructableObjectData();
        ...
        public static void Serialize(CampaignDestructableObjectData objectData, Stream stream, bool leaveOpen = false)
        {
