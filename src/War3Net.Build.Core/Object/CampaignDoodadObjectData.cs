...
{
    public sealed class CampaignDoodadObjectData
    {
        ...
        public CampaignDoodadObjectData(params ObjectModification[] modifications)
            : this()
        {
        ...
        internal CampaignDoodadObjectData()
        {
            _baseModifications = new Dictionary<int, ObjectModification>();
            _newModifications = new Dictionary<int, ObjectModification>();
        }

        public static CampaignDoodadObjectData Default => new CampaignDoodadObjectData() { _fileFormatVersion = ObjectDataFormatVersion.Normal, };
        ...
        public static CampaignDoodadObjectData Parse(Stream stream, bool leaveOpen = false)
        {
            try
            {
        ...
        public static void Serialize(CampaignDoodadObjectData objectData, Stream stream, bool leaveOpen = false)
        {
