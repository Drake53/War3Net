...
{
    public sealed class CampaignUpgradeObjectData
    {
        ...
        internal CampaignUpgradeObjectData()
        {
            _baseModifications = new Dictionary<int, ObjectModification>();
            _newModifications = new Dictionary<int, ObjectModification>();
        }

        public static CampaignUpgradeObjectData Default => new CampaignUpgradeObjectData() { _fileFormatVersion = ObjectDataFormatVersion.Normal, };
        ...
        public static CampaignUpgradeObjectData Parse(Stream stream, bool leaveOpen = false)
        {
            try
            {
                var data = new CampaignUpgradeObjectData();
        ...
        public static void Serialize(CampaignUpgradeObjectData objectData, Stream stream, bool leaveOpen = false)
        {
