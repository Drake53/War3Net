...
{
    public sealed class MapItemObjectData
    {
        ...
        public MapItemObjectData(params ObjectModification[] modifications)
            : this()
        {
        ...
        internal MapItemObjectData()
        {
            _baseModifications = new Dictionary<int, ObjectModification>();
            _newModifications = new Dictionary<int, ObjectModification>();
        }

        public static MapItemObjectData Default => new MapItemObjectData() { _fileFormatVersion = ObjectDataFormatVersion.Normal, };
        ...
        public static MapItemObjectData Parse(Stream stream, bool leaveOpen = false)
        {
            try
            {
                var data = new MapItemObjectData();
        ...
        public static void Serialize(MapItemObjectData objectData, Stream stream, bool leaveOpen = false)
        {
