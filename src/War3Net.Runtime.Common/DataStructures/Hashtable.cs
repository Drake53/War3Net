...
using War3Net.Runtime.Common.Core;

namespace War3Net.Runtime.Common.DataStructures
{
    public sealed class Hashtable : Agent
    {
        ...
        private readonly Dictionary<int, Dictionary<int, object>> _savedHandles;
        ...
        public Hashtable()
        {
            ...
            _savedHandles = new Dictionary<int, Dictionary<int, object>>();
        }
        ...
        public void SaveHandle(int parentKey, int childKey, object value)
        {
        ...
        public object LoadHandle(int parentKey, int childKey)
        {
