...
namespace War3Net.Runtime.Common.Enums.Object
{
    ...
    {
        private static readonly Dictionary<int, ItemStringField> _events = GetTypes().ToDictionary(t => (int)t, t => new ItemStringField(t));
        ...
        {
            return _events.TryGetValue(i, out var itemStringField) ? itemStringField : null;
        }
