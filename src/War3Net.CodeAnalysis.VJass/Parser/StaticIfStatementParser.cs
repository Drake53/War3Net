// ------------------------------------------------------------------------------
// <copyright file="StaticIfStatementParser.cs" company="Drake53">
...
namespace War3Net.CodeAnalysis.VJass
{
    ...
    {
        internal static Parser<char, VJassStatementSyntax> GetStaticIfStatementParser(
            ...
            Parser<char, VJassSyntaxTriviaList> trailingTriviaParser)
        {
            return statementParser.IfThenElse(
                ...
                (declarator, statements) => new VJassStatementStaticIfClauseSyntax(declarator, statements.ToImmutableArray()),
                ...
                (staticIfClause, elseIfClauses, elseClause, trivia, endIfToken) => (VJassStatementSyntax)new VJassStaticIfStatementSyntax(
                    staticIfClause,
