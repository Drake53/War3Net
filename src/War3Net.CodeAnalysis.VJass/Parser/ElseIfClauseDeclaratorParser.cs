...
namespace War3Net.CodeAnalysis.VJass
{
    ...
    {
        internal static Parser<char, VJassElseIfClauseDeclaratorSyntax> GetElseIfClauseDeclaratorParser(
        ...
        {
            return Map(
                (elseIfToken, condition, thenToken) => new VJassElseIfClauseDeclaratorSyntax(
                    elseIfToken,
                    condition,
                    thenToken),
                Keyword.ElseIf.AsToken(triviaParser, VJassSyntaxKind.ElseIfKeyword),
                expressionParser,
